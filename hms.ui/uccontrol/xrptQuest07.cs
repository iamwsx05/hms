...
namespace Hms.Ui
{
    public partial class xrptQuest07 : DevExpress.XtraReports.UI.XtraReport
    {
        public xrptQuest07(EntityQnRecord qnRecord)
        {
            InitializeComponent();
